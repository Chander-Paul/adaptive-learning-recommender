...
test_patterns = [
    [['enter','q'], ['play_audio','l'], ['respond','q'], ['submit','q'], ['enter','l'], ['play_video','l'], ['pause_video','l'], ['play_video','l']],
    [['enter','q'], ['play_audio','l'], ['respond','q'], ['submit','q'], ['respond','q'], ['submit','q'], ['respond','q'], ['submit','q']],  
    [['enter','q'], ['play_video','l'], ['pause_video','l'], ['play_video','l'], ['pause_video','l'], ['play_video','l']]
