...
class KPrototypesLearningPathClusterer:
    ...
    def analyze_clusters(self):
        ...
        # Save profiles
        cluster_profile_df.to_csv('visualizations/kprototypes_cluster_profiles.csv', index=False)
    ...
    def load_model(self, filepath='models/learner/kprototypes_learning_path_model.pkl'):
